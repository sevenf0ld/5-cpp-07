...
/*   Updated: 2024/04/21 12:51:15 by maiman-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void intro(const char *format, size_t size, Array<double> const &obj)
{
	...
	FORMAT_TEST(format);
	std::cout << AC_YELLOW << "size of obj passed as param is " << size << "." << AC_NORMAL << std::endl;
...
void test_copy(Array<double> &obj)
{
	...
	obj[2] = 1;
	obj[3] = 2;
	std::cout << "elements of obj passed as param upon changing element at index 2 and 3: ";
	print_element(obj.size(), obj);
